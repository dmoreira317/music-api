...
class Albums(models.Model):
    ...
    artistid = models.ForeignKey('Artists', models.DO_NOTHING, db_column='ArtistId', related_name='albums')  # Field name made lowercase.
...
class Tracks(models.Model):
    ...
    albumid = models.ForeignKey(Albums, models.DO_NOTHING, db_column='AlbumId', blank=True, null=True, related_name='tracks')  # Field name made lowercase.
    mediatypeid = models.ForeignKey(MediaTypes, models.DO_NOTHING, db_column='MediaTypeId', related_name='tracks')  # Field name made lowercase.
    genreid = models.ForeignKey(Genres, models.DO_NOTHING, db_column='GenreId', blank=True, null=True, related_name='tracks')  # Field name made lowercase.
